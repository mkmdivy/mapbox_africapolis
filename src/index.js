...
componentDidUpdate(prevProps, prevState) {
    ...
    if( prevState !== this.state) {
      ...
      const afterChangeComplete = () => {
          ...
          this.setState({c2n: collection.filter((o)=> {return o >= 30000 && o < 100000;}).length});
          this.setState({c3n: collection.filter((o)=> {return o >= 100000 && o < 300000;}).length});
          this.setState({c4n: collection.filter((o)=> {return o >= 300000 && o < 1000000;}).length});
          this.setState({c5n: collection.filter((o)=> {return o >= 1000000 && o < 3000000;}).length});
          this.setState({c6n: collection.filter((o)=> {return o >= 3000000;}).length});
          }

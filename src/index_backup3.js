...
render() {
    return (
      <div>
        <div className={classes.topleft}> <button className={classes.button} onClick={() => this.state.button==="From"? this.setState({button:"To"}): this.setState({button:"From"})}>{this.state.button}</button><headtitle> {this.state.name}</headtitle> <br/><br/>
